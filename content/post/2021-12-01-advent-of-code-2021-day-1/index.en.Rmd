...
summary: ''
authors: []
lastmod: '2021-12-01T18:42:43+01:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
Part one can be solved using **diff** and summing over the logical vector, where **diff_depth > 0**
...
```{r day-one-two}
shift_sum <- vector(mode = "numeric", length = nrow(test) - 2)
